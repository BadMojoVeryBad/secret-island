...
@injectable()
export class Fences extends Component {
    ...
    public create(): void {
        this.events.on('fence', (event: Phaser.Types.Tilemaps.TiledObject) => {
            const sprite = this.scene.add.sprite(this.constants.ZERO, this.constants.ZERO, 'textures', 'fence');
